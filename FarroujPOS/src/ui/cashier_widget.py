...
class CashierWidget(QWidget):
    ...
    def get_stylesheet(self):
        ...
        /* FIXED: Item card with border and round corners */
        #item_card {
            background-color: #ffffff;
    ...
    def create_menu_panel(self):
        ...
        self.category_scroll.setFixedHeight(55)
        self.category_scroll.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAlwaysOn)
    ...
    def create_cart_panel(self):
        ...
        # Cart table - FIXED: Proper column setup for visibility
        self.cart_table = QTableWidget()
        self.cart_table.setColumnCount(5)
        self.cart_table.setHorizontalHeaderLabels(["Item", "Qty", "Price", "Total", ""])

        # FIXED: Set all columns to fixed sizes so nothing gets squished
        ...
        # FIXED: Set explicit widths that fit in the cart panel
        self.cart_table.setColumnWidth(0, 110)  # Item - enough for name
        self.cart_table.setColumnWidth(1, 55)   # Qty - spinner width
        self.cart_table.setColumnWidth(2, 75)   # Price
        self.cart_table.setColumnWidth(3, 75)   # Total
        self.cart_table.setColumnWidth(4, 40)   # Remove button

        # FIXED: Hide vertical header (row numbers) to save space
        self.cart_table.verticalHeader().setVisible(False)

        # FIXED: Make table expand to fill width
    ...
    def create_item_card(self, item):
        # FIXED: Card with border and round corners
        card = QFrame()
        ...
        img_container.setStyleSheet("background-color: #f8f9fa; border-radius: 12px;")
    ...
    def update_cart_display(self):
        ...
        for i, item in enumerate(self.cart):
            ...
            # FIXED: Create item with explicit text and styling
            ...
            # FIXED: Set row height for visibility
