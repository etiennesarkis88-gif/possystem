...
class DatabaseManager:
    ...
    def initialize_database(self):
        ...
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS receipt_settings (
                ...
                business_name TEXT DEFAULT 'Farrouj POS',
                business_name_ar TEXT DEFAULT 'Farrouj POS',
                address TEXT,
                phone TEXT,
                logo_path TEXT,
                header_text TEXT,
                footer_text TEXT DEFAULT 'Thank you for your visit!',
                footer_text_ar TEXT DEFAULT 'Thank you for your visit!',
    ...
    def _insert_default_data(self):
        ...
        categories = [
            ("Farrouj", "Farrouj", "farrouj.png", "#E74C3C", 1),
            ("Arguileh", "Arguileh", "arguileh.png", "#9B59B6", 2),
            ("Sandwiches", "Sandwiches", "sandwich.png", "#F39C12", 3),
            ("Daily Meals", "Daily Meals", "daily.png", "#27AE60", 4),
            ("Sweets", "Sweets", "sweets.png", "#E91E63", 5),
            ("Drinks", "Drinks", "drinks.png", "#3498DB", 6),
            ("Plates", "Plates", "plates.png", "#E67E22", 7),
            ("Taouk", "Taouk", "taouk.png", "#1ABC9C", 8),
            ("Mezza", "Mezza", "mezza.png", "#795548", 9),
        ]
        ...
        if cursor.fetchone()[0] == 0:
            cursor.execute("""
                ...
                VALUES (1, 'Farrouj POS', 'Farrouj POS',
